process variant {
    ...
    singularity exec docker://staphb/samtools:1.12 samtools mpileup -A -d 8000 --reference ${params.reference}/NC_001489.fasta -B -Q 0 ${mypath}/alignment/\${samplename}.sorted.bam | singularity exec docker://staphb/ivar:latest ivar variants -r ${params.reference}/NC_001489.fasta -m 0 -p ${mypath}/variants/\${samplename}.variants -q 20 -t 0.03 -g ${params.reference}/NC_001489.gff3
    ...
    #singularity exec docker://staphb/samtools:1.12 samtools mpileup -A -B -d 8000 --reference ${params.reference}/KC248195.fasta -Q 0 ${mypath}/alignment/\${samplename}.sorted.bam | ivar consensus -t 0 -m 10 -n N -p ${mypath}/assembly/\${samplename}.consensus
