...
os.system(f"singularity exec docker://staphb/mafft:latest mafft --addfragments {current_dir}/output/extract/sum_consensus.fa {current_dir}/reference/hav_align/combined_genotype_aln > {current_dir}/output/extract/mafft_genotype_msa")
### get snp alignment and distance matrix
...
os.system(f"singularity exec docker://staphb/phytreeviz:latest phytreeviz -i {current_dir}/output/extract/SNPs_boot_genotype.contree -o {current_dir}/output/extract/SNPs_boot_genotype.contree.pdf --show_confidence")
os.system(f"singularity exec docker://staphb/phytreeviz:latest phytreeviz -i {current_dir}/output/extract/SNPs_boot_genotype.contree -o {current_dir}/output/extract/SNPs_boot_genotype.contree.png --show_confidence")
