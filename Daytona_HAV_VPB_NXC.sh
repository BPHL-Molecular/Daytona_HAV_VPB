...
mkdir ./output/trees
mv ./output/nextclade/nextclade.nwk ./output/trees
mv ./output/nextclade/nextclade.auspice.json ./output/trees
mv ./output/tree_with_reference* ./output/trees
mv ./output/nextclade/nextclade.csv ./output/genotype_mutation.csv
